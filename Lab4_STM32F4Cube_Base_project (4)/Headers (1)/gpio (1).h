...
//GPIOC
#define DIGIT_CONTROL_4 GPIO_PIN_1
#define DIGIT_CONTROL_3 GPIO_PIN_2
#define DIGIT_CONTROL_2 GPIO_PIN_4
#define DIGIT_CONTROL_1 GPIO_PIN_5
...
static const uint16_t segments[] = {SEG0,SEG1,SEG2,SEG3,SEG4,SEG5,SEG6,SEG7};
